...
## Write in the Form of $ (a + b)^3 $ or $(a - b)^3 $
...
### Factorize the expression, $a^4 + a^2b^2 + b^4$.

Here,
= $(a^2)^2 + 2a^2b^2 – a^2b^2 + (b^2)^2$
...
### Factorize: $ 49a^4 - 154a^2b^2 + 9b^4 $
...
### Factorize: $ \dfrac{x^4}{y^4} + \dfrac{x^2}{y^2} + 1 $
