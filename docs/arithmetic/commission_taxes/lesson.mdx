...
- $ \text{Commission Amount} = \frac{\text{Rate Percentage} \times \text{SP}}{100}$

- $ \text{Net Income} = \text{SP} - \text{Commission Amount}$

- $ \text{Commission Percent} = \frac{\text{Commission Amount}}{\text{SP}} \times 100\%$
...
$\text{Tax Amount} = \frac{\text{Rate}}{100} \times \text{Taxable Income}$
